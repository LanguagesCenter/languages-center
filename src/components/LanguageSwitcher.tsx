  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex items-center gap-1.5 px-2.5 py-1.5 text-sm font-medium text-navy/70 hover:text-teal rounded-full border border-border hover:border-teal/30 transition-colors"
      >
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 top-full mt-2 w-52 max-h-96 overflow-y-auto bg-white rounded-xl shadow-lg border border-border py-1.5 z-50"
        >
