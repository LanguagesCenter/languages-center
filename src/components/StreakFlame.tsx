interface StreakFlameProps {
  streak: number;
  size?: "sm" | "md" | "lg";
  // When the caller already renders its own "N day streak" text next to
  // the flame (e.g. a stat card), setting this to true keeps just the
  // pictogram so the count/label doesn't appear twice.
  iconOnly?: boolean;
}
